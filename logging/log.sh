...
case "$1" in
	dev)
		machines=("avd8@172.29.21.212" "avd8@172.29.100.228" "mike@172.29.247.35")
		;;
	qa)
...
while true; do
	...
	sudo cat /var/log/apache2/error.log | grep --text -Fv -f /var/log/it490/local.log | sudo tee -a /var/log/it490/local.log
